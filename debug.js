...
function DebugJS() {
	...
	this.DEFAULT_SHOW_CLEAR_BUTTON = true;
}

DebugJS.prototype = {
	init:  function(messageAreaId, messageBufferSize, showLineNums, showClearButton) {
		...
		this.DebugShowClearButton = showClearButton;
...
function DebugInit() {
	Debug = new DebugJS();
	Debug.init(Debug.DEFAULT_DEBUG_ARIA_ID, Debug.DEFAULT_BUFFER_SIZE, Debug.DEFAULT_SHOW_LINE_NUMS, Debug.DEFAULT_SHOW_CLEAR_BUTTON);
}
