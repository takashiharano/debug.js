...
var DebugJS = DebugJS || function() {
  ...
  this.properties = {
    ...
    scrollstep: {value: DebugJS.scrollWinTo.data.step, restriction: /^[0-9]+$/},
    scrollspeed: {value: DebugJS.scrollWinTo.data.speed, restriction: /^[0-9]+$/},
...
DebugJS.bat.exec = function() {
  ...
  if ((ctx.status & DebugJS.STATE_BAT_PAUSE) || (ctx.status & DebugJS.STATE_BAT_PAUSE_CMD)) {
    ...
    if (((new Date).getTime()) >= DebugJS.bat.ctrl.pauseTimeout) {
      bat._resume('cmd-key');
    } else {
